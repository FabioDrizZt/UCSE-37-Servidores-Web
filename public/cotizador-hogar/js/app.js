...
const guardarEnHistorial = () => {
  ...
  const historialCotizaciones = JSON.parse(window.localStorage.getItem('historialCotizaciones')) || []
  historialCotizaciones.push(cotizacion)
  window.localStorage.setItem('historialCotizaciones', JSON.stringify(historialCotizaciones))
  toast()
